...
@pytest.mark.parametrize(
    ...
    [
         ('natural', [3.14, 6.28, 9.42, 4.49, 7.73, 4.49, 7.73, 4.49, 7.73,],
          [(0, 0, 1), (0, 0, 2), (0, 0, 3), (1, -1, 1), (1, -1, 2), (1, 0, 1),
           (1, 0, 2), (1, 1, 1), (1, 1, 2)]),
         ('lnm', [3.14, 6.28, 9.42, 4.49, 4.49, 4.49, 7.73, 7.73, 7.73,],
          [(0, 0, 1), (0, 0, 2), (0, 0, 3), (1, -1, 1), (1, 0, 1), (1, 1, 1),
           (1, -1, 2), (1, 0, 2), (1, 1, 2)]),
         ('ln', [3.14, 6.28, 9.42, 4.49, 7.73, 5.76, 9.1, 6.99, 8.18,],
          [(0, 1), (0, 2), (0, 3), (1, 1), (1, 2), (2, 1), (2, 2), (3, 1),
           (4, 1)]),
         ('k', [3.14, 4.49, 4.49, 4.49, 5.76, 5.76, 5.76, 5.76, 5.76,],
          [(0, 0, 1), (1, -1, 1), (1, 0, 1), (1, 1, 1), (2, -2, 1), (2, -1, 1),
           (2, 0, 1), (2, 2, 1), (2, 1, 1)]),
         ('scale', [3.14, 4.49, 5.76, 6.28, 6.99, 7.73, 8.18, 9.1, 9.36,],
