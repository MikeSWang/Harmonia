...
combining spherical and Cartesian Fourier analyses for large-scale
galaxy clustering likelihood inference.
...
def display_args(logger=None, comm=None):
    """Display command-line arguments parsed by a function (
...
data_dir = Path(pipeline_dir).parent/"storage"
...
harmony = matplotlib.rc_params_from_file(
    os.path.join(pipeline_dir, 'harmony.mplstyle'),
