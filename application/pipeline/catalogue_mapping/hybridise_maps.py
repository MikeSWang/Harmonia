"""Hybridise spherical and Cartesian Fourier maps and summarise
statistics.
...
try:
    ...
    from pipeline import application_logger as logger
    from pipeline import data_dir, display_args
except ImportError:
